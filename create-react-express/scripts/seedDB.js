...
const restaurantSeed = [
  {
    ...
    rating: "4.4",
    review:"Awesome Onion rings!  Great service. Worth the wait.  Located in the back of market.  I will be back"
  ...
  },
  {
    ...
    rating:"4.5",
    review:"What an amazing restaurant! Stopped in here randomly on a trip to the area and was so impressed by the menu"
  ...
  },
  {
      ...
      rating:"4.5",
      review:"They have several options and can always customize something for you!"
  },
  {
      name:"West Egg Cafe",
      ...
      rating:"4.7",
      review:"OMG soooo amazing, matcha green tea, blueberries, banana, spinach, chia seeds, agave, almond milk"
  },
  {
      name:"Yeah! Burger",
      ...
      rating:"4.7",
      review:"best vegan bruger in town!!"
  },
  {
      name:"Poor Calvin's",
      ...
      rating:"4.5",
      review:"If you're visiting Atlanta for a short amount of time, this is the place to eat! Asian/Southern cuisine, a wonderful delight!"
  ...
  },
  {
      ...
      rating:"3.9",
      review:"Wow! This place is amazing and I am sad that I waited until my last day to check it out! Customer service is superb and food was just perfect!"
  },
  {
      ...
      rating:"4.3",
      review:"Excellent service and food. We had an appetizer of shrimp cocktail, fried green tomatoes, and fritters"
  },
  {
      name:"FIGO Pasta",
      ...
      rating:"4.6",
      review:"We tried the battered tofu with truffle fries and the spicy black bean burger with a side of zucchini fries."
  },
  {
      name:"Fresh To Order",
      ...
      rating:"4.1",
      review:"This is probably one of my absolute favorite places in the city."
  },
  {
    ...
    image:"https://b.zmtcdn.com/data/res_imagery/16902720_RESTAURANT_cfb5dd53238a70e1d8a77db7d7b68dae.jpg?fit=around%7C200%3A200&crop=200%3A200%3B%2A%2C%2A",
    rating:"4.5",
    review:"wait is too long,little over priced"
  }
